...
$query = "SELECT s.rollNo, s.name, nd.requestId,rr.requestDate, nd.noDueApproval, nd.noDueComment, nd.approvalDate
          FROM nodues nd
...
<head>
    ...
    <title>Fee Department Dashboard</title>
    ...
    <div class="container">
        <header>
            <div class="header-item">
                <h2>Fee Department Dashboard</h2>
            </div>
            <nav>
                <ul>
                    <li><a class="nav-link" href="FeeDashboard.php">Dashboard</a></li>
                    <li>|</li>
