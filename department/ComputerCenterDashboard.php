...
<head>
    ...
    <title>Computer Center Department Dashboard</title>
    ...
    <div class="container">
        <header>
            <div class="header-item">
                <h2>Computer Center Department Dashboard</h2>
            </div>
            <nav>
                <ul>
                    <li><a class="nav-link" href="ComputerCenterDashboard.php">Dashboard</a></li>
                    <li>|</li>
